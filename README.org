...
run it from the shell as an executable script or interactively from
...
[[file:img/invoke-menu.png]]

And from the command line:
#+begin_src bash
./clime-make.el quickstart greet.el        # scaffold + shebang
./clime-make.el init --self-dir myapp.el   # just the shebang
./clime-make.el bundle -o dist/app.el ...  # single-file distribution
#+end_src
